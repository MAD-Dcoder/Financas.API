...
function App() {
  ...
  const { usuarioLogado, isLoggedIn, handleLoginSuccess, handleLogout } = useContext(AuthContext);
  ...
  // ==========================================
  // ESTADOS DO CARTÃO (Ainda não extraídos para o Hook)
  // ==========================================
  ...
  return (
    <div className="app-container pt-4 px-3">
      ...
      <FlipCard 
        isCardFlipped={isCardFlipped} setIsCardFlipped={setIsCardFlipped}
        showBalance={showBalance}
        saldoAtual={saldoAtual} receitasDoMes={receitasDoMes} despesasDoMes={despesasDoMes}
        mesFiltro={mesFiltro}
        corCartao={corCartao} apelidoCartao={apelidoCartao} diaVencimento={diaVencimento} diaFechamento={diaFechamento} finalCartao={finalCartao} nomeCartao={nomeCartao} bandeiraCartao={bandeiraCartao}
        totalFaturaMes={totalFaturaMes} statusFatura={statusFatura} mesVencimentoFatura={mesVencimentoFatura}
        setShowCardSettings={setShowCardSettings} setTempDiaVencimento={setTempDiaVencimento} setTempDiaFechamento={setTempDiaFechamento} setTempCor={setTempCor} setTempApelido={setTempApelido} setTempFinal={setTempFinal} setTempNome={setTempNome} setTempBandeira={setTempBandeira}
      />

      <DonutChart 
        isCardFlipped={isCardFlipped} abaGrafico={abaGrafico}
        handleTouchStart={handleTouchStart} handleTouchMove={handleTouchMove} handleTouchEnd={handleTouchEnd}
        totalDespesasAtivas={totalDespesasAtivas} svgSegments={svgSegments}
        hoveredCategory={hoveredCategory} setHoveredCategory={setHoveredCategory}
        selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory}
        isChartAnimating={isChartAnimating} showBalance={showBalance}
        despesasGrafico={despesasGrafico} pagamentosGrafico={pagamentosGrafico}
        despesasArray={despesasArray} pagamentosArray={pagamentosArray}
        historicoData={historicoData} maxFaturaHist={maxFaturaHist}
        listaMeses={listaMeses} setMesFiltro={setMesFiltro}
      />

      <TransactionList 
        termoBusca={termoBusca} setTermoBusca={setTermoBusca}
        selectedCategory={selectedCategory} isCardFlipped={isCardFlipped} abaGrafico={abaGrafico}
        mesFiltro={mesFiltro} setShowMonthSelector={setShowMonthSelector}
        transacoesAgrupadas={transacoesAgrupadas}
        setTransacaoSelecionada={setTransacaoSelecionada} setMenuAcaoDetalhes={setMenuAcaoDetalhes}
        showBalance={showBalance} obterIconeCategoria={obterIconeCategoria}
      />
      ...
      <OffcanvasMenu 
        ...
        setShowProfile={setShowProfile} 
        usuarioLogado={usuarioLogado} 
        handleLogout={() => { setShowProfile(false); handleLogout(); }} 
      />

      <CardSettings 
        showCardSettings={showCardSettings} setShowCardSettings={setShowCardSettings}
        diaVencimento={diaVencimento} diaFechamento={diaFechamento} corCartao={corCartao} apelidoCartao={apelidoCartao} finalCartao={finalCartao} nomeCartao={nomeCartao} bandeiraCartao={bandeiraCartao}
        tempDiaVencimento={tempDiaVencimento} setTempDiaVencimento={setTempDiaVencimento} tempDiaFechamento={tempDiaFechamento} setTempDiaFechamento={setTempDiaFechamento}
        tempCor={tempCor} setTempCor={setTempCor} tempApelido={tempApelido} setTempApelido={setTempApelido} tempFinal={tempFinal} setTempFinal={setTempFinal}
        tempNome={tempNome} setTempNome={setTempNome} tempBandeira={tempBandeira} setTempBandeira={setTempBandeira}
        handleSalvarConfigCartao={handleSalvarConfigCartao}
      />

      <MonthSelector 
        showMonthSelector={showMonthSelector} setShowMonthSelector={setShowMonthSelector}
        listaMeses={listaMeses} mesFiltro={mesFiltro} setMesFiltro={setMesFiltro}
        setTermoBusca={setTermoBusca} setSelectedCategory={setSelectedCategory}
      />

      <TransactionForm 
        showBottomSheet={showBottomSheet} setShowBottomSheet={setShowBottomSheet}
        usuarioLogado={usuarioLogado} carregarTransacoes={carregarTransacoes}
        transacaoParaEditar={transacaoParaEditar} setTransacaoParaEditar={setTransacaoParaEditar}
      />

      <TransactionDetails 
        transacaoSelecionada={transacaoSelecionada} setTransacaoSelecionada={setTransacaoSelecionada}
        menuAcaoDetalhes={menuAcaoDetalhes} setMenuAcaoDetalhes={setMenuAcaoDetalhes}
        showBalance={showBalance} obterIconeCategoria={obterIconeCategoria}
        animatingStatusId={animatingStatusId} handleToggleStatusPagamento={handleToggleStatusPagamento}
        handleAbrirEdicao={handleAbrirEdicao} handleEfetuarExclusao={handleEfetuarExclusao} isDeleting={isDeleting}
      />
