...
import { 
  ...
  FiLogOut, FiChevronRight, FiX, FiSun, FiMoon 
} from 'react-icons/fi';

function OffcanvasMenu({ showProfile, setShowProfile, usuarioLogado, handleLogout, temaAtual, toggleTema }) {
  // Variável auxiliar para facilitar a checagem no CSS inline e classes
      ...
      <Offcanvas.Body className="p-0 d-flex flex-column">
        ...
        <div className="px-3 pt-4 flex-grow-1 overflow-auto">
          ...
          <div className={`card ${isDark ? 'dark-card bg-dark' : 'bg-white'} border-0 mb-4 shadow-sm`} style={{ borderRadius: '1rem' }}>
            ...
            {/* NOVA OPÇÃO: TEMA DARK / LIGHT (O INTERRUPTOR) */}
            <div 
            ...
            >
              <div className="d-flex align-items-center gap-3">
                ...
                <span className={isDark ? "text-white" : "text-dark"} style={{ fontSize: '14px' }}>
                  Aparência
                </span>
              </div>
